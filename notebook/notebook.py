# -*- coding: utf-8 -*-
"""
Created on Mon Jul 13 20:55:14 2020
...
class Note:
    ...
    def __init__(self, memo, tags=''):
        '''initialize a note with memo and optional space-separated tags.Automatically set the note's creation date and a
        unique id.'''
        self.memo = memo
        self.tags = tags
...
class Notebook:
    ...
    def _find_note(self, note_id):
        '''Locate the note with th given id.'''
